                ...
                <div class="row row-sm table-wrapper">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive my-data-table">
                            ...
                            <?php require_once VIEW_COMMON."pages/admin/profile/tables/affiliates_table.php"?>
                        </div>
...
<script type="module" src="/public/js/custom/frontend/pages/admin/profile/affiliates.js"></script>
