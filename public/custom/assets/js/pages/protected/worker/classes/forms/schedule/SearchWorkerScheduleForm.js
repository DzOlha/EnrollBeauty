import SearchScheduleForm from "../../../../user/classes/forms/schedule/SearchScheduleForm.js";

class SearchWorkerScheduleForm extends SearchScheduleForm {
    constructor(
        requester, submitUrl,
        apiUrlGetAllWorkerServices,
        apiUrlGetAllAffiliates,
        scheduleRenderer,
        optionBuilder, dateRenderer, api = false
    ) {
        super(
            requester, submitUrl, scheduleRenderer,
            optionBuilder, dateRenderer, api
        );
        this.apiUrlGetAllWorkerServices = apiUrlGetAllWorkerServices;
        this.apiUrlGetAllAffiliates = apiUrlGetAllAffiliates;
