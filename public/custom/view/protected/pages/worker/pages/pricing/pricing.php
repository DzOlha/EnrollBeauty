                ...
                <div class="row row-sm table-wrapper">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive my-data-table">
                            ...
                            <?php require_once VIEW_PROTECTED_PAGES."/worker/blocks/tables/pricing_table.php"?>
                        </div>
...
<!--Mine scripts-->
<script type="module" src="/<?=CUSTOM_ASSETS?>/js/pages/protected/worker/ui/pricing/pricing.js"></script>
