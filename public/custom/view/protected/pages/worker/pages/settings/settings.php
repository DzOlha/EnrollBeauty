                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="personalInformation">
                                        ...
                                        <div class="tab-content modal-form">
                                            <?php require_once VIEW_PROTECTED_PAGES . '/worker/blocks/forms/worker-edit-info-form.php'?>
                                        </div>
                                    </div>
                                    <div class="tab-pane" id="socialNetworks">
                                        ...
                                        <div class="tab-content modal-form">
                                            <?php require_once VIEW_PROTECTED_PAGES . '/worker/blocks/forms/worker-edit-socials-form.php'?>
                                        </div>
                                    </div>
...
<!--Mine scripts-->
<script type="module" src="/<?=CUSTOM_ASSETS?>/js/pages/protected/worker/ui/settings/settings.js"></script>
