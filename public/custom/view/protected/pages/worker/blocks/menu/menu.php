...
<!--            </li>-->
<!--            <li class="nav-sub-item">-->
<!--                <a class="nav-sub-link" href="/web/worker/profile/schedule">-->
<!--                    Schedule-->
<!--                </a>-->
<!--            </li>-->
<!--            <li class="nav-sub-item">-->
...
<!--    </li>-->
    ...
    <!---->
    <!--    <li class="nav-item">-->
    <!--        <a class="nav-link" href="/web/worker/profile/products">-->
    <!--            <span class="shape1"></span>-->
    <!--            <span class="shape2"></span>-->
    ...
    <!--        <ul class="nav-sub">-->
    <!--            <li class="nav-sub-item">-->
    <!--                <a class="nav-sub-link" href="/web/worker/profile/orders_product">-->
    <!--                    Products-->
    <!--                </a>-->
    <!--            </li>-->
    <!--            <li class="nav-sub-item">-->
    <!--                <a class="nav-sub-link" href="/web/worker/profile/orders_service">-->
    <!--                    Services-->
    <!--                </a>-->
    <!--            </li>-->
    <!--            <li class="nav-sub-item">-->
    <!--                <a class="nav-sub-link" href="/web/worker/profile/orders_other">-->
    <!--                    Other-->
    <!--                </a>-->
    <!--            </li>-->
    <!--        </ul>-->
    ...
    <!--        <ul class="nav-sub">-->
    <!--            <li class="nav-sub-item">-->
    <!--                <a class="nav-sub-link" href="/web/worker/profile/history">-->
    <!--                    Tab 1-->
    <!--                </a>-->
    <!--            </li>-->
    <!--            <li class="nav-sub-item">-->
    ...
    <!---->
    <!--    <li class="nav-item">-->
    <!--        <a class="nav-link" href="/web/worker/profile/statistics">-->
    <!--            <span class="shape1"></span>-->
    <!--            <span class="shape2"></span>-->
    ...
    <!---->
    <!--    <li class="nav-item">-->
    <!--        <a class="nav-link" href="/web/worker/profile/notification">-->
    <!--            <span class="shape1"></span>-->
    <!--            <span class="shape2"></span>-->
