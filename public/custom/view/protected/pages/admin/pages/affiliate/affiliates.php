                ...
                <div class="row row-sm table-wrapper">
                    ...
                    <div class="card-body">
                        <div class="row table-filter">
                            <div class="col-lg-3 d-lg-flex justify-content-start">
                                ...
                                <div class="button-wrapper mg-l-10">
                                    <button aria-label="Add Affiliate"
                                            class="btn ripple pd-x-25"
                                            id="add-affiliate-trigger"
                        ...
                        <div class="table-responsive my-data-table">
                            ...
                            <?php require_once VIEW_PROTECTED_PAGES."/admin/blocks/tables/affiliates_table.php"?>
                        </div>
...
<!--Mine scripts-->
<script type="module" src="/<?=CUSTOM_ASSETS?>/js/pages/protected/admin/ui/affiliate/affiliates.js"></script>
