                ...
                <div class="row row-sm table-wrapper">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive my-data-table">
                            ...
                            <?php require_once VIEW_PROTECTED_PAGES."/admin/blocks/tables/positions_table.php"?>
                        </div>
...
<script type="module" src="/<?=CUSTOM_ASSETS?>/js/pages/protected/admin/ui/position/positions.js"></script>
