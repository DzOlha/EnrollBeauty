...
<link href="/<?=CUSTOM_ASSETS?>/css/pages/protected/pages/admin/modal-with-workers.css" rel="stylesheet" />
                ...
                <div class="row row-sm table-wrapper">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive my-data-table">
                            ...
                            <?php require_once VIEW_PROTECTED_PAGES."/worker/blocks/tables/services_table.php"?>
                        </div>
...
<script type="module" src="/<?=CUSTOM_ASSETS?>/js/pages/protected/admin/ui/service/services.js"></script>
