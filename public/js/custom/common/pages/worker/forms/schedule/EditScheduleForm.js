...
class EditScheduleForm extends AddScheduleForm
{
    ...
    {
        super(requester, modalForm, optionBuilder, searchForm);
        this.scheduleBuilder = scheduleBuilder;
        this.dateRenderer = dateRenderer;
        this.timeRenderer = timeRenderer;

        this.submitActionUrl = API.WORKER.API.SCHEDULE.edit;

        this.cardBaseId = 'schedule-card';
        this.editIconClass = 'fe-edit-3';

        this.dataIdAttribute = 'data-schedule-id';
        this.apiGetSchedule = API.WORKER.API.SCHEDULE.get.one;
        this.apiGetFilledTimeIntervals = API.WORKER.API.SCHEDULE.get["edit-busy-time-intervals"];
    }
    getEditIcon(id) {
    ...
    _regenerateScheduleCard(data) {
        ...
        //this.deleteCallback(response.data.schedule_id);
    }
}
